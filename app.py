...
# mongodb+srv://shivamrai714714:*****@cluster0.j7dwyaj.mongodb.net/test
...
#-----------------------------------------------------------------
#JUST added to check our practice
#-----------------------------------------------------------------
#This end point is fired when TagName of TodoListApp is clicked 
...
def show():
    ...
    message="Please login to See your Todo List"
    return render_template('login.html' , message = message , link='/' , loginorlogout='Login')
